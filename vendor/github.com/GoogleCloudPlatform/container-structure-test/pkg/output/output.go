...
func (o *OutWriter) Banner(imageName string) {
	fileStr := fmt.Sprintf("====== Testing Image: %s ======", filepath.Base(imageName))
...
func (o *OutWriter) OutputResults(fullResults []*types.FullResult, imageName string) int {
	totalPass := 0
	totalFail := 0
